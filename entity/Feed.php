...
class Feed extends Api {
    ...
    protected function getKindProperties() {
        ...
        $property_map[self::SUBSCRIBER_URL_NAME] = parent::createStringProperty($this->subscriber_url, true);
        return $property_map;
    }
    ...
    public static function get($feed_url) {
        ...
        $feed_url_filter = parent::createStringFilter(self::SUBSCRIBER_URL_NAME, $feed_url);
